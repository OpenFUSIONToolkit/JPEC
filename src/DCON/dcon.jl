function MainProgram(in_path::String)
    ...
    if ctrl.mat_flag || ctrl.ode_flag
        ...
        println(
            "mlow = $(intr.mlow), mhigh = $(intr.mhigh), mpert = $(intr.mpert), mband = $(intr.mband), nn = $(ctrl.nn), sas_flag = $(ctrl.sas_flag), dmlim = $(ctrl.dmlim), qlim = $(intr.qlim), psilim = $(intr.psilim)"
        )
